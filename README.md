...
| [`flight-deal-tracker/`](flight-deal-tracker/) | Theo dõi giá vé máy bay cho các route cấu hình trong Google Sheet (skill: `flight-deal-tracker`), dùng 100% remote browser quét Google Flights và khuyến mãi hãng bay VN (VietJet, Vietnam Airlines, Bamboo), so sánh giá theo ngày, alert khi giá giảm mạnh hoặc dưới ngân sách. Setup 15 phút | Bản 1.0 |
